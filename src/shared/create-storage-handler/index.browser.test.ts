...
describe('createStorage', () => {
  ...
  test('sessionStorage', () => {
    const storageKey = 'test-session-storage';
    ...
    expect(storage.clear()).toBeUndefined();
    expect(storage.get()).toBeNullable();
    expect(sessionStorage.getItem(storageKey)).toBeNullable();
  });

  test('memoryStorage', () => {
    const storageKey = 'test-memory-storage';
